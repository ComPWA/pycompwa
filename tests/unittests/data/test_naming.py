...
from pycompwa.data.naming import _strip_index
...
@pytest.mark.parametrize(
    "input_list, expected",
    [
        (["gamma", "pi0", "pi0"], ["gamma", "pi0-1", "pi0-2"],),
        ([2, "three", 3], [2, "three", 3],),
        ([2, 3, 4, 4], [2, 3, "4-1", "4-2"],),
        (None, None),
    ],
...
@pytest.mark.parametrize(
    "mapping", [{2: "gamma", 3: "pi0", 4: "pi0"}, {2: 22, 3: 111, 4: 111},]
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"gamma": 2, "pi0-1": "three"}, [2, "three"], ["gamma", "pi0-1"],),
        ({"gamma": 2, "gamma-1.2": 3}, [2, 3], ["gamma", "gamma-1.2"],),
        ({2: 22, 3: 111, 4: 111}, [22, "111-1", "111-2"], [2, 3, 4],),
    ],
)
